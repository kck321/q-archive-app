# Generate per-agent manifests for phase 2 (batch1250.json, n=601-850).
...
rows = {r['n']: r for r in json.load(open(os.path.join(SCRATCH, 'batch1250.json'), encoding='utf-8'))}

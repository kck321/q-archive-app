# Generate per-agent manifests for phase 2 (batch1690.json, n=601-850).
...
rows = {r['n']: r for r in json.load(open(os.path.join(SCRATCH, 'batch1690.json'), encoding='utf-8'))}

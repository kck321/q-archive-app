# Generate per-agent manifests for phase 2 (batch1050.json, n=601-850).
...
rows = {r['n']: r for r in json.load(open(os.path.join(SCRATCH, 'batch1050.json'), encoding='utf-8'))}

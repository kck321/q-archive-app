...
| ✅ | Entities = 7,903 resolved mentions (headline) | 9271 |
| ✅ | core registry submetric = 5,273 | 5297 |
| ✅ | adjudicated tail submetric = 3,476 | 2922 |
...
| ✅ | submetrics sum to the headline | 5297 + 2922 + 1052 = 9271 |
| ✅ | the artifact ships the headline figure | 9271 |
...
| ✅ | canonical and mentions are distinct metrics | 1532 vs 9271 |
...
| ✅ | sectionInfo headlines 1,532 entities and 9,271 mentions | ok |
...
| ✅ | Entities headline = certified mentions / 2,099 posts | ok |
...
| ✅ | none of the held mentions is counted in Entities | 9271 |
...
| ✅ | entity totals are unchanged by the import | 1532 entities / 9271 mentions |
...
| ✅ | the provenance audit covers every certified occurrence | 10366 of 10366 |
| ✅ | the applied totals are the proven ones plus every ruling recorded since | 1532/9271 against 1532/9271 |
...
| ✅ | every ambiguous occurrence is retained unchanged | 66 ambiguous, 0 acted on |
...
| ✅ | the provenance audit describes the state it was run against | 1751/10366 against 1751/10366 |
...
| ✅ | the approved audit still holds its exact bytes | audit unchanged; inputs moved under 7 recorded decision(s) |
...
| ✅ | certified prose mentions = 9,271 | view 9271 / registry sum 9271 |
...
| ✅ | no occurrence is claimed by two identities | 10308 occurrences, 0 double-claimed |
| ✅ | per-post mention counts stay inside the identity that earned them | clean |
| ✅ | row count and identity count reconcile through the merge model | 1519 rows / 1532 identities / 23 in 10 merged rows |
...
| Q Entities | 9,271 | sum of per-entity mention counts | Canonical entities (1,332) and mentions (7,903) are DIFFERENT metrics, not a row-count mismatch — one entity is mentioned many times. The headline covers every resolved mention: 4,463 from the 93-entity core registry plus 3,440 from the 1,239 adjudicated-tail entities. Unresolved alias tokens are counted in neither. | An unresolved alias must never be shown as a resolved identification. |

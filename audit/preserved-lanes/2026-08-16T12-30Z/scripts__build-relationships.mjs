...
const checks = [
  ...
  ['Claim ↔ Source provided = the certified 438', byType.claim_source_provided === 438, byType.claim_source_provided ?? 0],
  ...
  ['unresolved edges = the 107 queue rows', byType.unresolved_occurrence === 107, byType.unresolved_occurrence ?? 0],
]

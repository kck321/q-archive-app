...
**4,128 relationships** across 4,918 posts.
...
| evidence ↔ claim | 664 | certified span overlap |
| claim ↔ source ↔ provided | 341 | `claimMeta.sourceProvided` |
...
| ✅ | Claim ↔ Source provided = the certified 341 | 341 |

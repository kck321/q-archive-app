...
**4,621 relationships** across 4,945 posts.
...
| prediction ↔ assertion | 934 | `claimMeta.semanticFamily` — sections stay separate |
...
| ✅ | Prediction ↔ assertion family = the certified 934 | 934 |

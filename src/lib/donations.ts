...
export const CRYPTO_WALLETS: CryptoWallet[] = [
  ...
  // XRP REMOVED by owner ruling 2026-08-28: "xrp kind of goes against the grain of what im
  // trying to do here since it's a bankers coin and q is semi anti banker." The address and its
  // QR are gone entirely rather than emptied, so it can never resurface by accident.

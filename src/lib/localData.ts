...
export const SEED_VERSION = 117  // 117: 2026-08-30 ruling, shipped 1 Sep 2026 — #4686's
                                 //     "WATERGATE x1000" IS A PREDICTION. posts.json changes
                                 //     (postAnalysis.predictions), and a reader stuck on 116
                                 //     reads posts from IndexedDB and never re-fetches, so the
                                 //     line would go on painting unclassified. The owner caught
                                 //     exactly this on the #4688 ruling, on the rendered page.
                                 // 116: 2026-08-30 — #4688 ITEMS 1-17 ARE DIRECTIVES. Six lines
                                 ...
                                 //     so a returning reader stuck on 114 would keep seeing 18
                                 //     themes and the two old labels while the archive certifies
                                 //     17 and one.
                                 // 114: 2026-08-26 — real researched synopses for tier 5 (132
                                 ...
                                 // 110: 2026-08-26 — "Hunter" merged into "Hunter Biden" (one
                                 ...
                                 //     the same info box acronyms already did. glossary.json
                                 //     changed content; a returning reader must reseed.
                                 // 106: 2026-08-26 — #1515 addendum. 4 more reporters the first
                                 ...
                                 //     posts.json, entities.json, entity-hovers.json,
                                 //     relationships.json, search-index.json and glossary.json all
                                 //     changed content, so a returning reader's IndexedDB must
                                 //     reseed or the fix never shows up locally. Also carries the
                                 //     new attachment-crop feature and the every-entity-gets-a-
                                 //     hover-synopsis fix from the same session, both code-only.
                                 // 104: 2026-08-26 — the disease/medical-authority theme sweep.
                                 ...
                                 //     beside them, which were already Claims.
                                 // 102: a fourth 2026-08-25 batch, the bracket "[D]"/"[R]" party
                                 ...
                                 //     directives 3,333 -> 3,334, #4949's first.
                                 // 98: "Vault 7" is an Entity on #836 — the WikiLeaks release Q
